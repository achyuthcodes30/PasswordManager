...
import subprocess 
from database_manager import store_passwords, find_users, find_password,store_masterpassdb
...
def update_masterpass():
    x=input('Please enter the masterpassword')
